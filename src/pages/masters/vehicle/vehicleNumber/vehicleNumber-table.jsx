...
const VehicleNumberTable = ({ vehicleNumberList, handleEdit,title,handleDelete }) => {
  ...
  const columns = [
    ...
    {
      title: 'VehicleId',
      dataIndex: 'vehicleNumId',
      key: 'vehicleNumId',
      width: '20%',
      ...getColumnSearchProps('vehicleNumId'),
    },
    {
...
export default VehicleNumberTable;